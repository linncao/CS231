/*
  ...
  *NOTE: the file, LandscapeDisplay.java got modified by Linn Cao Nguyen Phuong (CS231 B) on March 1st 2021
  to use Graphics2D instead of Graphics for the purpose of the class's Project 2: Conway's Game of Life.
*/
...
public class LandscapeDisplay
{
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        LandscapeDisplay display = new LandscapeDisplay(scape, 80);
    }
}